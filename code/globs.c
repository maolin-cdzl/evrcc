...
short lsp[ORDER];				/* Correlation coefficients                */
short lspi[ORDER];				/* Interpolation of correlation coeff      */

short pci[ORDER];				/* Interpolated prediction coefficients    */
short *gnvq;					/* Quantization table for fcb gain */
...
short bit_rate;					/* Current bitrate for encoder/decoder */

short FCBGainSize;				/* Current Fixed Codebook Gain Size */
short delay;					/* current frames delay */
short LPCflag;					/* LPC spectral transistion flag */

short fcbIndexVector[10];		/* ACELP fixed codebook index vector */
