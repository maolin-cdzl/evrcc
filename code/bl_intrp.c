...
void bl_intrp(
				 INT16 *output,	/* int ptr */
				 INT16 *input,	/* int ptr */
				 INT32 delay,	/* sign bit + 7bits int  + 24bits frac */
				 INT16 factor,	/* fractional value */
				 INT16 fl		/* int value */
)
{
	register int n;
	register INT16 t;
	register INT16 *f, *coef_ptr;
	static INT16 factor2 = 29491;
	INT32 loutput;
	INT16 offset;
