...
void
    ComputeACB(INT16 *residualm,
			   ...
			   INT16 rshift)
{
	static INT16 buffer[ACBMemSize + SubFrameSize + EXTRA];
	INT16 i;

	static INT16 FirstTime = 1;	/* init flag */

	/* initialization of buffer. Should be done in init routine for implementation. */
	if (FirstTime)
	{
		FirstTime = 0;
